...
select * from cars where price > (select avg(price) from cars) -- 1 варіант
select year from cars where price > (select avg(price) from cars -- 2 варіант
select * from cars where year in (select year from cars where price > (select avg(price) from cars)); -- 3 варіант
